...
# refer : https://github.com/DeepVoltaire/AutoAugment
...
class SubPolicy(object):
    ...
    # def __repr__(self):
    #     return "{self._operation1_name} with p:{self.p1} and magnitude:{self.magnitude1} \t" \
    #         "{self._operation2_name} with p:{self.p2} and magnitude:{self.magnitude2} \n"
